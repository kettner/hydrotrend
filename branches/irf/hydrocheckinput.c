 ...
 *----------------------------------------------------*/ 
        if (ep)
        {
            ...
            1 - Tstart[ep] / (Tstart[ep - 1] +
                              nyears[ep - 1] * Tchange[ep - 1]);
 ...
 *--------------------------------------------------*/ 
      ...
      if (ep)
        {
            ...
            1 - ELAstart[ep] / (ELAstart[ep - 1] +
                                nyears[ep - 1] * ELAchange[ep - 1]);
 ...
 *----------------------------------------------------------*/ 
        ...
        printf ("Checking baseflow range...\n");
           ...
           || baseflowtot[ep] > Pstart[ep] * totalarea / (dTOs * 365.0))
        {
